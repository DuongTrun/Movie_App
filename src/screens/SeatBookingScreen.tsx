...
import { FlatList, ImageBackground, ScrollView, StatusBar, StyleSheet, Text, TouchableOpacity, View, ToastAndroid } from 'react-native';
...
const generateDate = ()  => {
  const date = new Date();
  let weekday = ['Sun','Mon','Tue','Wed','Fri','Sat'];
  let weekdays = [];
...
const SeatBookingScreen = ({navigation,route}:any) => {
  ...
  const [twoDSeatArray,setTowDSeatArray] = useState<any[][]>(generateSeats());
  const [selectedSeatArray,setSelectedSeatAdrry] = useState([]);
  ...
  const BookSeats = async () => {
      ...
      && dateArray[selectedDateIndex] !== undefined)
    {
      try {
        ...
        console.error('Something went wrong while storing in BookSeat Function',error);
      }
